<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="InterviewsByRegion.aspx.cs" Inherits="WRLI_Reports.InterviewsByRegion" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="InterviewsByRegion.aspx">InterviewsByRegion.aspx</b>
        .style1
        {
            width: 633px;
        }
...
<script language="javascript">
    ...
    <h2  style="width:100%" id="headingInt" >
        Interview Data by Region for WRE
    </h2>
    <br /><br />

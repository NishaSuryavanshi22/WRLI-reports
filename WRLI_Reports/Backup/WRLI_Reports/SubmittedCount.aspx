<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="SubmittedCount.aspx.cs" Inherits="WRLI_Reports.SubmittedCount" %>
...
<script language="javascript">
    ...
    <h2>
        Submitted Count By Region
    </h2>
    <p>
        <asp:Label ID="Label1" runat="server" Text="Region:,Agent:"></asp:Label>
    </p>
            ...
            <td>
                <div style="border: thin groove #808080;width:910px; overflow: scroll;" runat="server"
                    ...
                    <div id="dvgr" style="width:100%">
                        <asp:GridView ID="grdSubmitCount" runat="server" CellPadding="4" EnableModelValidation="True"  RowStyle-Wrap="false"

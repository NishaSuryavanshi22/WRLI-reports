<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="RatedByRegion.aspx.cs" Inherits="WRLI_Reports.RatedByRegion" %>

<%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" TagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css">
        <b href="RatedByRegion.aspx" > RatedByRegion.aspx</b >
        .style1 {
            width: 633px;
        }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    function Print(dvgr) {
        ...
        prntWindow.document.write(prntData.outerHTML);<a href="RatedByRegion.aspx">RatedByRegion.aspx</a>
    ...
    <h2 style="width: 100%" id="headingInt">Rated by Region
    </h2>
    <br />
    <br />
                ...
                <td>
                    ...
                    <div style="border: thin groove #808080; width: 910px; overflow: scroll;" runat="server"
                        ...
                        <div id="dvgr" style="width: 100%">
                            <asp:GridView ID="grInterviewsByRegion" onRowdatabound="grInterviewsByRegion_RowDataBound" runat="server" CellPadding="4" EnableModelValidation="True" RowStyle-Wrap="false"

<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="RatedbyState.aspx.cs" Inherits="WRLI_Reports.RatedbyState" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="RatedbyState.aspx">RatedbyState.aspx</b>
        .style1
        {
            width: 633px;
        }
    ...
    <table width="100%" id="tblHandle">
        ...
        <tr>
         ...
         <td class="style2" colspan="2">
                ...
                <asp:Label runat="server" ID ="lblAgent" Text="Reporting for Agent" ></asp:Label>
            ...
            <td class="style1" >
                <asp:TextBox ID="txtFrom" runat="server" Style="margin-right: 2px"></asp:TextBox>
                <asp:Image ID="imgfrom" runat="server" ImageUrl="~/AjaxCalendarExtendar.gif" Style="margin-right: 15px" />
                to:
                <asp:TextBox ID="txtTo" runat="server" Style="margin-right: 2px"  ></asp:TextBox> 
        ...
        <tr>
            ...
            <td class="style1" >
            <asp:RadioButtonList ID="rdListType" runat="server" Visible="false">
            ...
            <asp:ListItem>None</asp:ListItem>
                ...
                <asp:CheckBox ID="chkInterview" runat ="server" Visible="false" Text="Display Interview Detail" ForeColor="Green" />
                <asp:CheckBox ID="chkRef" runat ="server" Visible="false" Text="Display Only latest ReferenceID" ForeColor="Green" />
                 </td>
        </tr>
            ...
            <td>
                ...
                <div style="border: thin groove #808080;width:910px; overflow: scroll;" runat="server"
                    ...
                    <div id="dvgr" style="width:100%">
                        <asp:GridView ID="grInterviewsByState" runat="server" OnRowDataBound="grInterviewsByState_RowDataBound" CellPadding="4" EnableModelValidation="True"  RowStyle-Wrap="false"

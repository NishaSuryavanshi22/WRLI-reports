<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ClaimsByRegion.aspx.cs" Inherits="WRLI_Reports.ClaimsByRegion" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="ClaimsByRegion.aspx">ClaimsByRegion</b>
        .style1
        {
            width: 633px;
        }
...
<script language="javascript">
    ...
    <table width="100%" id="tblHandle">
        ...
        <tr>
            ...
            <td class="style1" >
                <asp:RadioButtonList ID="rdListType" runat="server" OnSelectedIndexChanged="rdListType_SelectedIndexChanged">
            <asp:ListItem>All</asp:ListItem>
               <asp:ListItem>Rider</asp:ListItem>

        <asp:ListItem>Baseplan</asp:ListItem>
        <asp:ListItem>Level</asp:ListItem>
        <asp:ListItem>Graded</asp:ListItem>
        <asp:ListItem>Modified</asp:ListItem>
        <asp:ListItem>09/07</asp:ListItem>
            ...
            <td>
                ...
                <div style="border: thin groove #808080;width:910px; overflow: scroll;" runat="server"
                    ...
                    <div id="dvgr" style="width:100%">
                        <asp:GridView ID="grRequirementsByRegion" OnRowDataBound="grRequirementsByRegion_RowDataBound" runat="server" CellPadding="4" EnableModelValidation="True"  RowStyle-Wrap="false"

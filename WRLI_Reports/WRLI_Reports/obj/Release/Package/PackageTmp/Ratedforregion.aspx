<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ratedforregion.aspx.cs" Inherits="WRLI_Reports.Ratedforregion" %>
...
<body>
    <form id="form1" runat="server">
            <h2  style="width:100%">
     Rated for Region  : 
        <asp:Label ID="regioncode" colour="red" runat="server" Text=""></asp:Label> 
       </h2>
        <div>
        ...
        <td>
            <div style="border: thin groove #808080; width: 910px; overflow: scroll;" runat="server"
                ...
                <div id="dvgr" style="width: 200%">
                    <asp:GridView ID="grdratedforregion" onrowdatabound="grdratedforregion_RowDataBound" runat="server" CellPadding="4" EnableModelValidation="True" RowStyle-Wrap="false"

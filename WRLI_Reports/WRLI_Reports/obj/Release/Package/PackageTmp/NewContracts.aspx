<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="NewContracts.aspx.cs" Inherits="WRLI_Reports.NewContracts" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="NewContracts.aspx">Paid, Placement and Persistency Report </b>
        .style1
        {
            width: 633px;
        }
...
<%--                     <asp:ListItem Text= "ALL" ></asp:ListItem>--%>
                    <asp:ListItem Text= "New Agents" ></asp:ListItem>
                    <asp:ListItem Text= "Reinstated Agents" ></asp:ListItem>
                </asp:DropDownList>

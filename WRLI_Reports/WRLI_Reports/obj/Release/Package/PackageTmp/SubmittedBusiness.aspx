<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="SubmittedBusiness.aspx.cs" Inherits="WRLI_Reports.SubmittedBusiness" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="SubmittedBusiness.aspx">Paid, Placement and Persistency Report </b>
        .style1
        {
            width: 633px;
        }
                ...
                <div style="border: thin groove #808080;width:910px; overflow: scroll;" runat="server"
                    ...
                    <div id="dvgr" style="width:100%">
                        <asp:GridView ID="grdSubmittedReport" runat="server" CellPadding="4" EnableModelValidation="True"  RowStyle-Wrap="false"
                            ForeColor="#333333" OnRowDataBound="grdSubmittedReport_RowDataBound"  GridLines="Both" Visible="true" Font-Bold="FALSE" EnableSortingAndPagingCallbacks ="true">

<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="RequirementByRegion.aspx.cs" Inherits="WRLI_Reports.RequirementsByRegion" %>

<%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" TagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css">
        <b href="RequirementsByRegion.aspx" > RequirementsByRegion.aspx</b >
        .style1 {
            width: 633px;
        }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 style="width: 100%">Under writer Requirements by Region for WRE
    </h2>
    <br />
    <br />
    <div width="100%" id="tblHandletime">
        <table width="100%" id="tblHandle">
            ...
            <tr>
                <td class="style2" id="tdProd">Select Type :
                </td>
                <td class="style1">
                    <asp:RadioButtonList ID="rdListType" runat="server">
                        ...
                        <asp:ListItem>Non-Med</asp:ListItem>
                        <asp:ListItem>MortgageCertificate</asp:ListItem>

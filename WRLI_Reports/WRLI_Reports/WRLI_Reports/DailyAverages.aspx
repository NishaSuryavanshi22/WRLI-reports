<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="DailyAverages.aspx.cs" Inherits="WRLI_Reports.DailyAverages" %>
    ...
    <table width="100%" id="tblHandle">
        ...
        <tr>
            ...
            <td class="style1" colspan="4">
                ...
                <asp:Image ID="imgTo" runat="server" ImageUrl="~/AjaxCalendarExtendar.gif" Style="margin-right: 15px" Visible="false" />
                <asp:Button ID="GO" runat="server" Text="Go!" OnClick="Button1_Click"/>
                <asp:Button ID="idYtd" runat="server" Text="YTD" OnClick="Ytd_Click"/>
                <asp:Button ID="idMtd" runat="server" Text="MTD" OnClick="Mtd_Click"/><a href="DailyAverages.aspx">DailyAverages.aspx</a>
            </td>
            </tr>

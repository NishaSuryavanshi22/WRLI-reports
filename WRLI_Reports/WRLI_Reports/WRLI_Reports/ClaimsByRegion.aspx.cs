       ...
       // SqlConnection con = new SqlConnection(CSCUtils.Utils.GetConnectionString());
        ...
        protected void InvokeSP()
        {
            ...
            commPolicy.CommandText = "select	REGION_CODE, REGION_NAME, "+  		
						"ISNULL(dbo.PAID_COUNT_FOR_REGION (REGION_CODE,'" +AgentID+ "','"+ sCompany + "','" +FromDate+"' , '" +ToDate +"'),0) as TOTAL_POLICIES, "+ 		
						...
						"      AND (PAID_POLICY + PAID_CLAIM + RESCINDED_CLAIM + PENDING_CLAIM > 0) AND "+  		

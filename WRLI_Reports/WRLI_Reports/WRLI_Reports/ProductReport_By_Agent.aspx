<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ProductReport_By_Agent.aspx.cs" Inherits="WRLI_Reports.ProductReport_By_Agent" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="ProductReport_By_Agent.aspx">Product Report By Agent </b>
        .style1
        {
            width: 633px;
        }
    ...
    <table width="100%" id="tblHandle">
        ...
        <tr>
           ...
           <td class="style2">
            ...
            <td class="style1">
                <asp:DropDownList ID="ddlregion" runat="server"  OnPreRender="ddlagent_PreRender" EnableViewState="true">
</asp:DropDownList>
            </td>
        </tr>
           ...
           <td class="style2">
            ...
            <td class="style1">
                <asp:DropDownList ID="ddlregioncode" runat="server"  OnPreRender="ddlagent_PreRender" EnableViewState="true">
</asp:DropDownList>
            </td>
        </tr>

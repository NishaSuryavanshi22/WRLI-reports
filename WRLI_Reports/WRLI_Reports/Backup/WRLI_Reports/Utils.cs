...
namespace CSCUtils
{
    class Utils
    {
        ...
        {
            string sDBName = ConfigurationManager.AppSettings["eDeliveryDB"];
            return sDBName;
        }
        ...
        public static string GetConnectionString()
        {
            try
            {
                ...
                string sDBConnectionString = ConfigurationManager.AppSettings["dbConnectionString"].ToString().Replace("%DBName%", sDBName);
                sDBConnectionString = sDBConnectionString.Replace("%DBServer%", sDBServer);

...
namespace WRLI_Reports
{
    public partial class ApplicationsReceived : System.Web.UI.Page
    {
        ...
        {
            comm = new SqlCommand("SELECT AGENT_NUMBER,ISNULL(DISPLAYNAME,'') AS DISPLAYNAME,SORTNAME FROM AGENT_HIERLIST");
            comm.Connection = con;

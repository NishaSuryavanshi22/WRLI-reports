...
"GROUP BY pr.region_code ORDER BY " + Orderby + "";
        ...
        protected void grdSubmittedReport_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                link.NavigateUrl = "ProductReport_By_Agent.aspx?&Fromdate=" + FromDate + "&Todate=" + ToDate +  "&COMPANY_CODE=" + sCompany + "&Region_Code=" + sRegion + "&Datatype=" + Datatype + "&Products=" + products + "";
                link.Text = text;
                link.Target = "_blank";

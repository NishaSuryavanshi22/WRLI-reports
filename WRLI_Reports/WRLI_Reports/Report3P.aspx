<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Report3P.aspx.cs" Inherits="WRLI_Reports.Report3P" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="Report3P.aspx">Paid, Placement and Persistency Report </b>
        .style1
        {
            width: 633px;
        }
...
<script language="javascript">
    ...
    <h2  style="width:100%">
        Paid,Placement and Persistency
    </h2>
    <br /><br />
                ...
                <div style="border: thin groove #808080;width:910px; overflow: scroll;" runat="server"
                    ...
                    <div id="dvgr" style="width:100%">
                        <asp:GridView ID="grRequirementsByRegion" runat="server" CellPadding="4" EnableModelValidation="True"  RowStyle-Wrap="false"
                            ForeColor="#333333" GridLines="Both" Visible="true" Font-Bold="true" EnableSortingAndPagingCallbacks ="true">

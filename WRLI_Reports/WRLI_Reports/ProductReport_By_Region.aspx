<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ProductReport_By_Region.aspx.cs" Inherits="WRLI_Reports.PolicyReport_By_Region" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="PolicyReport_By_Region.aspx">Product Report By Region </b>
        .style1
        {
            width: 633px;
        }
...
<script language="javascript">
    ...
    <table width="100%" id="tblHandle">
        ...
        <tr>
           ...
           <td class="style2">
            ...
            <td class="style1">
                <asp:DropDownList ID="ddlregion" runat="server"  OnPreRender="ddlagent_PreRender">
                </asp:DropDownList>
            </td>
        </tr>
    ...
    <td class="style2">
     ...
     <td class="style1">
         <asp:DropDownList ID="ddlagentID" runat="server"  OnPreRender="ddlagent_PreRender" EnableViewState="true">
         </asp:DropDownList>
     </td>
 </tr>
         ...
         <tr>
           ...
           <td class="style2">
            ...
            <td class="style1">
                <asp:DropDownList ID="ddlProductTypes" runat="server"  OnPreRender="ddlProductTypes_PreRender">
                </asp:DropDownList>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="style1" >
                ...
                <asp:RadioButtonList ID="rdListType" runat="server" Visible="true">
            ...
            <td>
                ...
                <div style="border: thin groove #808080;width:910px; overflow: scroll;" runat="server"
                    ...
                    <div id="dvgr" style="width:100%">
                        <asp:GridView ID="grdSubmittedReport" OnRowDataBound="grdSubmittedReport_RowDataBound" runat="server" CellPadding="4" EnableModelValidation="True"  RowStyle-Wrap="false"

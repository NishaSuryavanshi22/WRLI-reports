...
{
    public partial class PaidBusiness : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (! IsPostBack)
            {
                ...
                txtTo.Text = DateTime.Now.ToString("MM/dd/yyyy", CultureInfo.InvariantCulture);//mm/dd/yyyy format couldnt be changed
                txtFrom.Text = System.DateTime.Now.AddMonths(-6).ToString("d");// curreentmonth-6 in days format

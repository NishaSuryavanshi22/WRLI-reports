<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="AgentLicenseList.aspx.cs" Inherits="WRLI_Reports.AgentLicenseList" %>
            ...
            <td>
                <div style="border: thin groove #808080;width:910px; overflow: scroll;" runat="server"
                    ...
                    <div id="dvgr" style="width:100%">
                        <asp:GridView ID="grdHandling" runat="server" CellPadding="4" EnableModelValidation="True"  RowStyle-Wrap="false" EnableSortingAndPagingCallbacks ="true"

<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="InterviewCallData.aspx.cs" Inherits="WRLI_Reports.InterviewCallData" %>
 <%@ Register Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" tagPrefix="ajax" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <style type="text/css"><b href="InterviewCallData.aspx">InterviewCallData</b>
        .style1
        {
            width: 633px;
        }
...
<script language="javascript">
    ...
    <table width="100%" id="tblHandle">
        ...
        <tr>
            ...
            <td class="style1" >
                <asp:TextBox ID="txtFrom" runat="server" Style="margin-right: 5px" OnTextChanged="txtFrom_TextChanged"></asp:TextBox>
        ...
        <tr>
            ...
            <asp:ListItem>None</asp:ListItem>
                ...
                <asp:CheckBox ID="chkInterview" runat ="server" Text="Display Interview Detail" ForeColor="Green" />
                <asp:CheckBox ID="chkRef" runat ="server" Text="Display Only latest ReferenceID" ForeColor="Green" />
                 </td>
        </tr>

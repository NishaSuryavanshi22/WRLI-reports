<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Claimsforregion.aspx.cs" Inherits="WRLI_Reports.WebForm1" %>
...
<body>
    ...
    <h2  style="width:100%">
     Claims for Region   
        <asp:Label ID="regioncode" runat="server" Text=""></asp:Label> 
</h2>
